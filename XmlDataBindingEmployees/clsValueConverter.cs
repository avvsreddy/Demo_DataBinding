...
{
    //This Class is used to Convert Values from one form to another
    //IValueConverter :=> Provides way to apply custom Logic to the binding 
    public class clsValueConverter : IValueConverter
    {
